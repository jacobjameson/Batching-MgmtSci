...
\ite \textbf{Quality metrics unchanged:} 72-hour returns show identical null effects across specifications.
\end{itemize}
...
\noindent\textbf{Response:} \textcolor{blue}
...
\begin{enumerate}
\item Added treatment time analysis (Appendix Table D.ZZ)
\item Added any 72-hour return analysis (Appendix Table D.ZZ)
