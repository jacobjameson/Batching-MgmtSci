...
Table XX summarizes our findings. Combining imaging and capacity costs, discretionary batching imposes an estimated \textbf{\$349} (\$294--417) in direct costs per affected patient. Capacity costs account for 64\% of the total, reflecting the substantial LOS increase we document.
...
\caption*{Figure A2: CONSORT Flow Diagram for Sample Selection}    
\label{fig:consort}    
\begin{tablenotes}
\small
