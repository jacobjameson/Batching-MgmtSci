...
Our revised main results (Table 4) now incorporate the expanded controls and respond to Reviewer 3’s suggestion to employ methods that are more robust to physician-level unobserved heterogeneity. In addition to our standard 2SLS estimates using batch tendency as the instrument, Table 4 includes estimates from the Unbiased Jackknife Instrumental Variables Estimator (UJIVE). 
