...
We obtained administrative records for 129,489 ED encounters at MGH from November 2021 through December 2022. The data comprise five linked modules: encounters, imaging orders, laboratory orders, provider assignments, and medication administrations. We applied analogous sample restrictions to those described in Appendix \ref{app:sample}: we retained adult patients ($\geq$ 18 years), excluded providers with fewer than 500 encounters, excluded complaints with fewer than 1,000 occurrences, excluded complaints with batch rates below 5\%, and restricted to encounters with at least one imaging order. The resulting analytical sample comprises 26,875 encounters.
...
\begin{tabular}{lccccc}
\toprule
& Sequenced mean & \multicolumn{2}{c}{\underline{2SLS}} & \multicolumn{2}{c}{\underline{OLS}} \\
& (1) & (2) & (3) & (4) & (5) \\
\midrule
